...
*Abstract:* This paper examines how tariff-induced food and beverage inflation disproportionately burdens low- and middle-income U.S. households. Using WTO trade data and the Consumer Expenditure Survey, we show that the lowest income quintile allocates 32.6% of post-tax income to food while consuming only one-third the absolute quantity of top earners. To account for this vulnerability, we employ a non-homothetic Stone-Geary utility framework with a rigid subsistence floor. While standard homothetic models (Cobb-Douglas and CES) overstate consumer substitution capabilities amid real-world retail supply chain disruptions, the Stone-Geary model captures a severe "subsistence squeeze." Our simulations show a 10% price shock that forces a regressive 17.0% budget burden on the lowest quintile compared to 5.3% for the highest, evaporating nearly all supernumerary income. Furthermore, by evaluating the exact income adjustments required to hold baseline utility constant, we demonstrate that targeted annual fiscal transfers of $265 per household under a reported spending baseline (Scenario A), and up to $550 under an institutional USDA Thrifty Food Plan baseline (Scenario B), are strictly required to restore welfare neutrality to the lowest income quintile. We advocate for these income-indexed transfer mechanisms to insulate vulnerable populations from modern trade policy shocks. <br>
...
-- *Abstract:* Applied US tariffs have risen sharply since the 2018-19 US-China trade war and escalated further in 2025. Tariff-induced price increases on imported intermediates are a primary channel through which supply chain disruption reaches domestic firms. Using an 11-year audit of Federal Reserve Small Business Credit Survey appendices (2015-2025), WTO trade data, and US Census data, we examine cost pressure heterogeneity within the small-business sector. On the extensive margin (2022-2024), micro-firms (1-4 employees) report the lowest cost-pressure incidence (71-77%), while 10-49-employee firms report the highest (81-89%), an inverted-U pattern reflecting micro-firms’ more limited import dependence. On the intensive margin (2025), micro-firms show the widest pass-through/absorption gap (19 percentage points versus 10-14 for mid-sized small businesses). A Stone-Geary cost function explains this divergence through non-substitutable input floors. Manufacturing shows the highest import-cost exposure with constrained pass-through, and Census data show it is the only benchmark sector whose firm count fell over 2017-2022, consistent with tariff-era consolidation. Tariffs create a two-stage vulnerability: most micro-firms are shielded by limited import dependence, but those exposed face markedly worse outcomes. <br>
...
- **ESG and Its Impact on Investor Sentiment.** (w/ Michael Gallagher & Erick W. Rengifo). <br>
- **Bond ETF Performance During the COVID-19 Crisis.** (w/ Jay Surti). <br>
