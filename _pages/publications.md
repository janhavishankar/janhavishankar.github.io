...
*Abstract:* This paper examines the impact of tariffs on inflation and household budgets across income levels and regions in the United States, focusing on food and beverages (necessity goods) that disproportionately burden low- and middle-income households. Using WTO trade data and the U.S. Consumer Expenditure Survey, we identify key trading partners and analyze how tariff-induced food price increases affect consumption patterns. Our empirical baseline reveals that lower-income households spend a significantly larger share of their budget on food (32.6% of post-tax income) while consuming only one-third of the absolute quantity of top earners. To quantify welfare effects, we employ a non-homothetic Stone-Geary utility framework to account for subsistence requirements. We find that for the lowest income quintile, a rigid subsistence floor of $5,278 per year creates an inflexible expenditure constraint, causing tariff-induced price hikes to evaporate nearly all supernumerary income, defined as the income remaining after the subsistence requirements are met. Our simulations show that a 10% price shock forces a regressive budget burden of 17.0% on the lowest quintile compared to just 5.3% for the highest quintile. Correspondingly, simulated utility losses under the Stone-Geary framework systematically exceed those predicted by standard homothetic frameworks (Cobb-Douglas and Constant Elasticity of Substitution), which overstate substitution capabilities amid real-world retail disruptions, localized freight bottlenecks, and the structural removal of low-cost budget alternatives. We conclude by advocating targeted policy measures, such as inflation-indexed tax credits or expanded safety nets, to mitigate these highly regressive welfare penalties. <br> 
...
- **The Impact of Tariffs and Supply Chain Disruption on Business Costs and Market Survival Across Firm Sizes in the US.** (w/ Erick W. Rengifo). <br>
